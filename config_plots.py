...
MAX_PRICE_CHANGE_PCT_5M = 5
MAX_PRICE_CHANGE_PCT_15M = 5
MAX_PRICE_CHANGE_PCT_30M = 5
MAX_PRICE_CHANGE_PCT_1H = 10
MAX_PRICE_CHANGE_PCT_2H = 10
MAX_PRICE_CHANGE_PCT_4H = 10
MAX_PRICE_CHANGE_PCT_12H = 15

max_limits_pa_plot = {
    '5m': (MAX_X_REL_VOL, MAX_PRICE_CHANGE_PCT_5M),
    '15m': (MAX_X_REL_VOL, MAX_PRICE_CHANGE_PCT_15M),
    '30m': (MAX_X_REL_VOL, MAX_PRICE_CHANGE_PCT_30M),
    '1h': (MAX_X_REL_VOL, MAX_PRICE_CHANGE_PCT_1H),
    '2h': (MAX_X_REL_VOL, MAX_PRICE_CHANGE_PCT_2H),
    '4h': (MAX_X_REL_VOL, MAX_PRICE_CHANGE_PCT_4H),
    '12h': (MAX_X_REL_VOL, MAX_PRICE_CHANGE_PCT_12H),
}
